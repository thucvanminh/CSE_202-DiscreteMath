...
public class EiCONP3 {
        ...
        public static void main(String[] args) throws IOException {
            ...
            for(int i = 0; i<graph.length-1;i++){
                if(!graph[i].visited){
                    sb.append(i+" ");
                    List<Vertex> verticesInCom = new ArrayList<>();
                    bfs(graph[i],verticesInCom );
                }
                sb.append("\n");
            }
        ...
        static void bfs(Vertex v, List<Vertex> verticesInCom){
            Queue<Vertex> q = new ArrayDeque<Vertex>();
            int totalVerticesInCom=0;
            int totalEdgeInCom =0;
            q.add(v);
            v.visited = true;
            ...
            totalVerticesInCom= verticesInCom.size();
            for(Vertex x: verticesInCom){
                totalEdgeInCom+=x.adjacentVertices.size();
            }
            sb.append(totalVerticesInCom+" "+totalEdgeInCom/2+" ");
        }
